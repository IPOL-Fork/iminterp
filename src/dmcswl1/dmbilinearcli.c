...
{
    puts("Bilinear demosaicing demo, P. Getreuer 2010-2011\n");
    puts("Usage: imintdmbilinear [options] <input file> <output file>\n"
...
#endif
    puts("Example: \n"
        "   imintdmbilinear -p RGGB frog.bmp frog-dm.bmp");
}

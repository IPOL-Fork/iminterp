...
#endif
    puts("Example: ");
    puts("   imintace -a 5 -w 1/r -m interp:12 input.bmp output.bmp\n");
}
...
int main(int argc, char *argv[])
{
    ...
    if(!(f = (float *)ReadImage(&width, &height, param.input_file,
    ...
    if(!WriteImage(u, width, height, param.output_file,
